...
Route::prefix('v1')->group(function(){
    ...
    Route::get('/', function(){
        return 'Congratulations Server Live :)';
    });
    ...
    Route::controller(AuthController::class)->prefix('/auth')->group(function (){
        ...
        Route::post('/logout', 'logout')->middleware('auth:api')->name('auth.logout');  // logout
    });
    ...
    Route::controller(UserController::class)->prefix('/users')->group(function (){
        ...
        Route::put('/',  'update')->middleware('auth:api');     // update user
        // todo after asking on it
        // Route::delete('/', 'delete')->middleware('auth:api');
    });
    ...
    Route::controller(FollowsController::class)->prefix('/follow')->group(function (){
        ...
        Route::post('/{profile}', 'store')->middleware('auth:api');
    ...
    Route::controller(ProfileImageController::class)->prefix('/images')->group(function (){
        ...
        // Route::put('/{profileImage}', 'update')->middleware('auth:api');
        Route::delete('/{profileImage}', 'delete')->middleware('auth:api');
    });
    ...
    Route::controller(PhotoController::class)->prefix('/photos')->group(function (){
        ...
        Route::delete('/{photo}', 'delete')->middleware('auth:api');
    });
    ...
    Route::controller(SavedPostController::class)->middleware('auth:api')->prefix('/saved-posts')->group(function (){
        Route::get('', 'index');
        Route::post('/{post}', 'store');
    });
